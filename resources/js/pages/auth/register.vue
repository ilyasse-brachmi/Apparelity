      ...
      form(method="POST" class="flex-col items-center justify-center")
        div(class="flex justify-center")
          div(class="flex items-center justify-between w-full px-8 py-4 border-b-2 border-primary max-w-[30rem]")
            input(type="text" placeholder="Name" class="bg-transparent py-2 text-lg outline-none border-none w-full")
            Icon(icon="ic:outline-email" class="text-3xl sm:text-4xl text-primary cursor-pointer")
        div(class="flex justify-center")
          div(class="flex items-center justify-between w-full px-8 py-4 border-b-2 border-primary max-w-[30rem]")
            input(type="text" placeholder="Email" class="bg-transparent py-2 text-lg outline-none border-none w-full")
            Icon(icon="ic:outline-email" class="text-3xl sm:text-4xl text-primary cursor-pointer")
        div(class="flex justify-center")
          div(class="flex items-center justify-between w-full px-8 py-4 border-b-2 border-primary max-w-[30rem]")
            input(type="password" placeholder="Password" class="bg-transparent py-2 text-lg outline-none border-none w-full")
            Icon(icon="ri:eye-off-line" class="text-3xl sm:text-4xl text-primary cursor-pointer")
            //- ri:eye-line
        div(class="flex justify-center")
          div(class="flex items-center justify-between w-full px-8 py-4 border-b-2 border-primary max-w-[30rem]")
            input(type="password" placeholder="Confirm Password" class="bg-transparent py-2 text-lg outline-none border-none w-full")
            Icon(icon="ri:eye-off-line" class="text-3xl sm:text-4xl text-primary cursor-pointer")
            //- ri:eye-line
