...
div(class="bg-gray-100 rounded p-10 sm:w-[18rem] 2xl:w-[19rem] h-[27rem] transition duration-700")
  div(class="relative max-h-[20rem]")
    img(v-if="product?.product_image" :src="`/storage/home/${product.product_image.split('home/')[1]}`" alt="Product Image" class="h-full w-full min-h-[15rem] min-w-[15rem] rounded-lg hover:scale-105 cursor-pointer duration-200")
