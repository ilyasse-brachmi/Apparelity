...
const categories = {1:'Headwear', 2:'Shoes', 3:'Bags', 4:'Clothes'};
const materials = {1:'Cotton', 2:'Leather', 3:'Linen', 4:'Nylon'};
defineProps(['categories','price', 'materials'])
</script>
<template lang="pug">
div(class="flex items-center bg-white h-screen overflow-hidden")
	div(class="max-h-screen duration-200 ltr:left-0 rtl:right-0 shadow-xl overflow-y-auto h-screen text-gray-600 min-w-[20rem] w-fit duration-200")
